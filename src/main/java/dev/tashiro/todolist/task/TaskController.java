package dev.tashiro.todolist.task;
...
import dev.tashiro.todolist.utils.Utilts;
...
public class TaskController {
  ...
  public ResponseEntity update(@RequestBody TaskModel taskModel, HttpServletRequest request,
    ...
    if (!task.getIdUser().equals(idUser)) {
      return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Você não tem permissão para editar esta tarefa");
    }

    Utilts.copyNonNullProperties(taskModel, task);
